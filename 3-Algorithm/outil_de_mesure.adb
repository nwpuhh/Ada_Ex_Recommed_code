...
package body Outil_De_Mesure is
   ...
   -- Renvoie la i-Ã¨me dimension du produit dans le tapis, en mm
   -- I=1 correponds Ã  la largeur, I=2 Ã  la hauteur et I=3 Ã  la profondeur
   Function Dim(I: Integer) return Float is
      Resultat : Float;
   begin
      -- On centre la valeur sur la mesure normale
      -- La valeur retournÃ©e est entre mesure-(erreur/2.0) et mesure+(erreur/2.0)
